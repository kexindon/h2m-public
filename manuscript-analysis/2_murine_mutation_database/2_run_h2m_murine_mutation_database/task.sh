...
#SBATCH -n 16                     # Number of tasks (really number of CPU Cores/task). Don't specify more than 16 unless approved by the system admin
...
cd /net/bmc-lab2/data/lab/sanchezrivera/kexindong/h2m-db
...
python3 h2m_db.py ${FILE} ${folder_name}